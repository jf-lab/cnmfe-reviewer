...
# Average CV score on the training set was: 0.9135332566533529
exported_pipeline = make_pipeline(
    VarianceThreshold(threshold=0.005),
    PCA(iterated_power=10, svd_solver="randomized"),
    MinMaxScaler(),
    ExtraTreesClassifier(bootstrap=True, criterion="gini", max_features=0.7000000000000001, min_samples_leaf=4, min_samples_split=2, n_estimators=100)
)
